...
import { setBrandFilter, clearBrandFilter, getAllMenClothingsAsync, deleteProductAsync } from "../../Services/Action/productAction";
import { AiOutlineEdit } from "react-icons/ai";
import { MdDeleteOutline } from "react-icons/md";
import { useNavigate } from "react-router";

const MenClothes = () => {
    const men_clothes = useSelector((state) => state.men_clothes);
    ...
    useEffect(() => {
        dispatch(getAllMenClothingsAsync());
    }, []);

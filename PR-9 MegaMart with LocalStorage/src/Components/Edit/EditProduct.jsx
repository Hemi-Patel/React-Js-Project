...
import { editProducts, getProduct } from "../../Services/Action/productAction";
...
const EditProduct = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        dispatch(editProducts(inputForm))
        navigate("/menclothes")
    }
    return (
                ...
                <Col lg={8} md={10}>
                    ...
                    <Form onSubmit={handleSubmit}>
                        ...
                        <Form.Group as={Row} className="mb-3 align-items-center">
                            ...
                            <Col sm="8">
                                <Form.Select className="shadow-none" name="category" onChange={handleInput}>
                                    <option value=" ">Select Category</option>
                                    {["T-shirts", "Shirts", "Casual Shirts", "Formal Shirts"].map((v, i) => (
                                        <option key={i} value={v} selected={inputForm.category == v}>
                                            {v}
                                        </option>
                                    ))}
                                </Form.Select>

...
import { addMenClothing } from "../../Services/Action/productAction";
...
const AddMenClothes = () => {
    ...
    const validateForm = () => {
        ...
        else if (!/^https?:\/\/.+\.(jpg|jpeg|png|gif|webp)$/i.test(inputForm.p_image))
            newErrors.p_image = "Enter a valid image URL (jpg, png, etc.).";
    ...
    const handleSubmit = (e) => {
        ...
        if (validateForm()) {
            ...
            dispatch(addMenClothing(newProduct));
            navigate("/menclothes");
        }
    };
                        ...
                        <Form.Group as={Row} className="mb-3 align-items-center">
                            ...
                            <Col sm="8">
                                ...
                                >
                                    ...
                                    {["T-shirts", "Shirts", "Casual Shirts", "Formal Shirts"].map(
                                        (v, i) => (

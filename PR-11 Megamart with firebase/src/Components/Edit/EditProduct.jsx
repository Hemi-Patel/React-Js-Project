...
const EditProduct = () => {
    ...
    const { id } = useParams();
    const singleProduct = useSelector((state) => state.product || null);
...
// import { getProductAsync, editProductsAsync } from "../../Services/Action/productAction";
// import { Button, Col, Container, Form, Row, Card } from "react-bootstrap";
...
//     const product = useSelector((state) => state.product || null);
...
//     // When Redux product changes, fill form
//     useEffect(() => {
//         if (product) {
//             setFormData({
...
//     const handleSubmit = (e) => {
//         e.preventDefault();
//         dispatch(editProductsAsync(formData));
//         navigate("/menclothes");
//     };
